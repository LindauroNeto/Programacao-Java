...
public class PasswordCreator {
	static ArrayList<String> organizador = new ArrayList<String>();
	static Random aleatorio = new Random();
	static char ranNumber;
	// v Insipirado pela Amannitta!!! Não foi feito originalmente por mim!!!!! Confira o repositório dela: https://github.com/Amannitta/Gerador-de-Senhas
	static String opcoesGeral = "abcçdefghijklmnopqrstuvwxyzABCÇDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#$_%&?*§=+¢/\\";
	static String opcoesLetra = "abcçdefghijklmnopqrstuvwxyzABCÇDEFGHIJKLMNOPQRSTUVWXYZ";
	static String opcoesMais = "0123456789!@#$_%&?*§=+¢/\\";
