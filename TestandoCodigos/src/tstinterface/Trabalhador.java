...
public class Trabalhador {
	...
	Trabalhador(String nome, int idade) {
		this.nome = nome;
		this.idade = idade;
	}
	...
	static class Telemarketing extends Trabalhador implements Trabalhadores {
		...
		public void voltaPraCasa(String horario, String meioDeLocomocao) {
			System.out.format("%s está indo para casa de %s, saindo às %s.\n", nome, meioDeLocomocao.toLowerCase(),
					horario);
		}

		public void surpresa() {
			System.out.format(
					"No final do dia... %s chega em casa cansado e tem um festa supresa de seu aniversário! %s estah completando %d anos!\n",
					nome, nome, idade + 1);
		}
	}
}
